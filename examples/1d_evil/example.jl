...
# Solution algorithms
problem_child_solve(Evil1d.M, nstages, risk, solver, [inivol], niters; verbose=true)
...
seed!(2)
primal_pb, primal_trajs, primal_lbs, primal_aux, Ubs = primalsolve(Evil1d.M, nstages, risk, solver, [inivol], niters; verbose=true, ub=true)
