...
# Maximum outflow
Maxturb = [x[2] for x in HYDRO_PLANTS]
# Maximum stored energy
Maxvol = [x[3] for x in HYDRO_PLANTS]
# initial stored energy
inivol = [x[4] for x in HYDRO_PLANTS]
...
thermal_c = [x[3] for x in THERMAL_PLANTS]

GTmax = [x[5] for x in THERMAL_PLANTS]
GTmin = [x[4] for x in THERMAL_PLANTS]
