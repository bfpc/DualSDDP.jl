...
plt.figure(figsize=(6,4));
plt.semilogy(1:niters, dual_ubs_fw./primal_lbs_fw .- 1; label="Dual UB / Primal LB, FW");
...
plt.semilogy(1:niters, io_ubs_fw./io_lbs_fw .- 1; label="IO UB/LB, FW");
